...
// const editProfileForm = document.querySelector('.form -edit')
// const addCardForm = document and so on and son on

// const new editProfileValidator((), '');
// const new addCardFormValidator ((), '');
